...
<div class="w-full bg-[#000cf9] md:hidden" x-data="{isNav:false}">
    ...
    <div x-show="isNav" @click.away="isNav=false" x-cloak>
        <ul class=" text-white text-md">
            <a href="/" class="">
                <li class="px-4 mx-2 py-2 hover:bg-[#3b44ee] hover:rounded-md {{request()->routeIs('home') ? 'bg-[#3b44ee] rounded-md' : ''}}">
                    Home
                </li>
            </a>

            <li class="px-4 mx-2 py-2 hover:bg-[#3b44ee] hover:rounded-md {{request()->routeIs('aboutus.*') ? 'bg-[#3b44ee] rounded-md' : ''}}" x-data="{isDrop: false}">
                ...
                <div class="dropdown inline-block relative" >
                    ...
                    <ul class=" absolute  text-[#3b44ee] dark:text-zinc-200 font-normal text-sm pt-1 w-52 z-10 bg-slate-50 dark:bg-slate-700 shadow-lg"  x-show="isDrop"  @mouseover.outside="isDrop = false" x-cloak>

                        <a href="{{route('aboutus.introduction')}}">
                            <li class="px-4 py-2 {{request()->routeIs('aboutus.introduction') ? 'bg-[#3b44ee] text-white' : ''}}  shadow-sm shadow-[#3b44ee] hover:bg-[#3b44ee] hover:text-white">
                                Introduction
                            </li>
                        </a>
                        <a href="{{route('aboutus.os')}}">
                            <li class="px-4 py-2 {{request()->routeIs('aboutus.os') ? 'bg-[#3b44ee] text-white' : ''}} hover:bg-[#3b44ee] hover:text-white shadow-sm shadow-[#3b44ee]">
                                Organizational Structure
                            </li>
                        </a>
                        <a href="{{route('aboutus.ec')}}">
                            <li class="px-4 py-2 {{request()->routeIs('aboutus.ec') ? 'bg-[#3b44ee] text-white' : ''}} hover:bg-[#3b44ee] hover:text-white shadow-sm shadow-[#3b44ee]">
                                Executive Committee
                            </li>
                        </a>
                        <a href="{{route('aboutus.sm')}}">
                            <li class="px-4 py-2 {{request()->routeIs('aboutus.sm') ? 'bg-[#3b44ee] text-white' : ''}} hover:bg-[#3b44ee] hover:text-white shadow-sm shadow-[#3b44ee]">
                                Staff Members
                            </li>
                        </a>
                    </ul>
            ...
            <li class="px-4 mx-2 py-2 hover:bg-[#3b44ee] hover:rounded-md {{request()->routeIs('programs.*') ? 'bg-[#3b44ee] rounded-md' : ''}}" x-data="{isDrop: false}">
                ...
                <div class="dropdown inline-block relative" >
                    ...
                    <ul class=" absolute  text-[#3b44ee] dark:text-zinc-200 font-normal text-sm pt-1 w-52 z-10 bg-slate-50 dark:bg-slate-700 shadow-lg"  x-show="isDrop"  @mouseover.outside="isDrop = false" x-cloak>
                        ...
                        <a href="{{route('programs.rmp')}}">
                            <li class="px-4 py-2 {{request()->routeIs('programs.rmp') ? 'bg-[#3b44ee] text-white' : ''}}  shadow-sm shadow-[#3b44ee] hover:bg-[#3b44ee] hover:text-white">
                                Resource Mobilization Program
                            </li>
                        </a>
                        <a href="{{route('programs.pwp')}}">
                            <li class="px-4 py-2 {{request()->routeIs('programs.pwp') ? 'bg-[#3b44ee] text-white' : ''}}  shadow-sm shadow-[#3b44ee] hover:bg-[#3b44ee] hover:text-white">
                                Promotion and Welfare Program
                            </li>
                        </a>
                        <a href="{{route('programs.pp')}}">
                            <li class="px-4 py-2 {{request()->routeIs('programs.pp') ? 'bg-[#3b44ee] text-white' : ''}}  shadow-sm shadow-[#3b44ee] hover:bg-[#3b44ee] hover:text-white">
                                Partnership Program
                            </li>
                        </a>
                        <a href="{{route('programs.crp')}}">
                            <li class="px-4 py-2 {{request()->routeIs('programs.crp') ? 'bg-[#3b44ee] text-white' : ''}}  shadow-sm shadow-[#3b44ee] hover:bg-[#3b44ee] hover:text-white">
                                Currently Running Programs
                            </li>
                        </a>
                    </ul>
            ...
            <a href="{{route('reservation')}}" class="{{request()->routeIs('reservation') ? 'bg-[#3b44ee] rounded-md' : ''}}">
                <li class="px-4 mx-2 py-2 hover:bg-[#3b44ee] hover:rounded-md {{request()->routeIs('reservation') ? 'bg-[#3b44ee] rounded-md' : ''}}">
                    Reserve Training Center
                </li>
            </a>
            <a href="{{route('contact')}}" class="{{request()->routeIs('contact') ? 'bg-[#3b44ee] rounded-md' : ''}}">
                <li class="px-4 mx-2 py-2 hover:bg-[#3b44ee] hover:rounded-md {{request()->routeIs('contact') ? 'bg-[#3b44ee] rounded-md' : ''}}">
                    Contact Us
                </li>
            </a>

            <li class="mx-2">
                <button id="theme-toggle" type="button" class="text-white dark:text-gray-400 hover:bg-[#3b44ee] dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-md p-2.5">
                    <svg id="theme-toggle-dark-icon" class="hidden  w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
                    <svg id="theme-toggle-light-icon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
                </button>
            </li>
