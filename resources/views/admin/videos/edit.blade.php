        ...
        <div class="px-5 py-5">
            ...
            <form method="post" action="{{route('admin.videos.update',$video->id)}}" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="title" id="title" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" required value="{{$video->title}}">
                </div>

                {{-- For link --}}
                <div class="mt-5">
                    <label for="link" class="block font-bold text-gray-600 dark:text-gray-200">Video Link</label>
                    <input type="text" name="link" id="link" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" required value="{{$video->link}}">
                </div>
                ...
                <div class="mt-4">
                    ...
                    <button class="px-6 py-1 border-0 shadow-sm hover:shadow-md bg-red-500 hover:bg-red-600 rounded-md text-white mx-5">
                        <a href="{{ route('admin.videos.index') }}" >Cancel</a>
                    </button>
                </div>
            </form>
