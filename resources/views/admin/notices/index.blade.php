...
@section('main')
    ...
    <div class="flex-1">
        <div class="px-5 py-5">
            ...
            <div class=" w-44 h-32 mx-4 mt-4 p-2 shadow-md shadow-orange-300 dark:shadow-gray-600 rounded-md bg-orange-500 hover:shadow-sm hover:cursor-pointer">
            ...
            <table class="border border-gray-200 w-full mt-10 shadow-md rounded-md ">
                ...
                @foreach ($notices as $notice)
                    <tr>
                        ...
                        <td class="text-gray-900 font-bold px-5 border hover:text-[#5977E9] dark:hover:text-[#5977E9] dark:text-white">
                            <a href="/storage/{{$notice->filepath}}" class="cursor-pointer" download>
                                {{$notice->title}} 
                            </a>
                        </td>
