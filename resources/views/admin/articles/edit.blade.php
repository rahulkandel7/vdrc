        ...
        <div class="px-5 py-5">
            ...
            <form method="post" action="{{route('admin.articles.update',$article->id)}}" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="title" id="title" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" required value="{{$article->title}}">
                </div>
                ...
                <div class="mt-5">
                    ...
                    <textarea  name="description" id="description" class="editor border-0 w-full focus:ring-transparent focus:border-primary bg-transparent mt-2">{{$article->description}}</textarea>
                </div>
