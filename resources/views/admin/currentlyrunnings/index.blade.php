    ...
    <div class="flex-1">
        <div class="px-5 py-5">
            ...
            <hr>
                ...
                <div class="w-56 h-32 mx-4 mt-4 p-2 shadow-md dark:shadow-fuchsia-800 rounded-md bg-fuchsia-500 shadow-fuchsia-200 hover:shadow-sm hover:cursor-pointer">
                    ...
                    <h1 class="text-4xl font-bold text-right text-white mr-4">{{count($currentlyrunnings)}}</h1>
                    </div>
                </div>
            ...
            <table class="border border-gray-200 w-full mt-10 shadow-md rounded-md ">
                ...
                @foreach ($currentlyrunnings as $currentlyrunning)
                    <tr>
                        ...
                        <div id="deletemodal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0  align-middle"  >
                            <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto ">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{route('admin.currentlyrunnings.delete')}}">
                                    @csrf
            ...
            <div class="fixed bottom-3 right-7">
                <a href="{{ route('admin.currentlyrunnings.create') }}">
