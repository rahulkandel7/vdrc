        ...
        <div class="px-5 py-5">
            ...
            <form method="post" action="{{route('admin.publications.update',$publication->id)}}" enctype="multipart/form-data">
                ...
                <div class="mt-5">
                    ...
                    <input type="text" name="name" id="name" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2" required value="{{$publication->name}}">
                </div>
                ...
                <div class="mt-5">
                    ...
                    {{-- For Type --}}
                    <div class="mt-5">
                        <label for="type" class="block font-bold text-gray-600 dark:text-gray-200">Select Type</label>
                        <select name="type" id="type" class="border-[#5976e970] border-2 rounded-md w-full focus:ring-transparent focus:border-[#5977E9] bg-transparent mt-2">
                            <option value="report" @if($publication->type == "report") selected @endif> Report</option>
                            <option value="newsletter" @if($publication->type == "newsletter") selected @endif> News Letter</option>
                ...
                <div class="mt-4">
                    ...
                    <button class="px-6 py-1 border-0 shadow-sm hover:shadow-md bg-red-500 hover:bg-red-600 rounded-md text-white mx-5">
                        <a href="{{ route('admin.publications.index') }}" >Cancel</a>
                    </button>
                </div>
            </form>
