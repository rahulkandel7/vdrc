            ...
            <hr>
                ...
                <div class="w-44 h-32 mx-4 mt-4 p-2 shadow-md dark:shadow-lime-800 rounded-md bg-lime-500 shadow-lime-200 hover:shadow-sm hover:cursor-pointer">
                    ...
                    <div class="flex justify-between">
                        <i class="fa fa-images fa-2x text-white opacity-70"></i>
                    <h1 class="text-4xl font-bold text-right text-white mr-4">{{count($slideshows)}}</h1>
                    </div>
                </div>
                ...
                @foreach ($slideshows as $slideshow)
                    <tr>
                        ...
                        <td class="text-gray-600 font-semibold px-5 border  py-2">
                            ...
                            <button onclick="showdelete({{$slideshow->id}})">
