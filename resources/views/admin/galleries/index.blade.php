    ...
    <div class="flex-1">
        <div class="px-5 py-5">
            ...
            <hr>
                ...
                <div class="w-56 h-32 mx-4 mt-4 p-2 shadow-md dark:shadow-sky-800 rounded-md bg-sky-500 shadow-sky-200 hover:shadow-sm hover:cursor-pointer">
                    <h2 class="text-xl font-bold text-white">No of Gallery</h2>
                    <div class="flex justify-between">
                        <i class="fas fa-image fa-2x text-white opacity-70"></i>
                    <h1 class="text-4xl font-bold text-right text-white mr-4">{{count($galleries)}}</h1>
                    </div>
                </div>
                ...
                @foreach ($galleries as $gallery)
                    <tr>
                        ...
                        <td class="text-gray-600 font-semibold px-5 border w-32 py-2">
                            ...
                            <button onclick="showdelete({{$gallery->id}})">
