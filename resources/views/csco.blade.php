    ...
    <div class="w-11/12 mx-auto shadow-sm py-5 shadow-gray-300 dark:shadow-gray-900 rounded my-4 ">
        <div class="grid md:grid-cols-3">
            <div class="md:col-span-2">
                ...
                <p class="px-4 font-bold my-2 text-zinc-600 dark:text-zinc-400 text-lg">
                ...
                <div class="grid grid-cols-3 gap-x-5 px-5">
                    <div>
                        <img src="{{asset('images/staff/11.jpeg')}}" class="rounded shadow-md  mx-auto">
                    </div>
