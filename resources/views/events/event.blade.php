            ...
            <div class="md:col-span-2">
                ...
                @foreach ($events as $event)
                    <div class="grid grid-cols-2 gap-x-10 p-6 images shadow-lg m-2 rounded-md">
                      ...
                      <div>
                          <h3 class="text-2xl text-[#5977E9] dark:text-zinc-300 font-bold">{{$event->title}}</h3>
                          <p class="my-2 text-justify">
                              {!!$event->description!!}
                          </p>
                          <a href="{{route('eventsview',$event->id)}}" class="px-4 py-1 bg-[#5977E9] hover:bg-[#4260da] rounded shadow-md text-white my-2">
                              Read More
                          </a>
                      </div>
                  </div>
