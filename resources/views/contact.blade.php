            ...
            <div>
                <form class="px-5">
                    ...
                    <div class="px-5 py-2">
                        ...
                        <input type="text" name="name" id="name" class="w-full rounded-md dark:text-black  border-zinc-600 dark:border-zinc-300 focus:ring-[#000cf9] active:ring-[#000cf9] focus:border-[#000cf9] active:border-[#000cf9] mt-1">
                    </div>
                    ...
                    <div class="px-5 py-2">
                        ...
                        <textarea  id="name" class="w-full rounded-md dark:text-black  border-zinc-600 dark:border-zinc-300 focus:ring-[#000cf9] active:ring-[#000cf9] focus:border-[#000cf9] active:border-[#000cf9] mt-1"></textarea>
                    </div>
                    
                    <div class="flex justify-center my-4">
                        <input type="submit" value="Submit" class="px-8 py-1 rounded-md bg-[#000cf9] text-white hover:bg-[#666cd8] cursor-pointer">
                    </div>
                </form>
            </div>
        </div>
